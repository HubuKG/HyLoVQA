...
def plot_result(*args, **kwargs):
    ...
    这是一个占位函数。
    原代码想画图，但函数缺失。
    为了不报错，我们这里什么都不做，直接跳过。
    """
    print("[Warning] plot_result function was missing. Skipping plot.")
    pass

def save_results_matrix(*args, **kwargs):
    """
    防止下一个可能出现的报错
    """
    print("[Warning] save_results_matrix function was missing. Skipping save.")
    pass
