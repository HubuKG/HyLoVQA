...
from hylomodeling_t5_our import VLT5
...
class VLT5VQA(VLT5):
    ...
    def train_step(self, batch, current_task_id, proto_alpha, proto_beta, mem_num_Q = 0, total_num_Q = 1000, memory=False):
        ...
        # === [新增] 提取 Alignment Loss ===
        # 这一步至关重要，否则 Trainer 里的 loss_meter_align 收不到值
        if 'loss_alignment' in output:
            result['loss_alignment'] = output['loss_alignment']
        # ================================
